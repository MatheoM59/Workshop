import type { Gates, HealthStatus, Position } from "../type";

const couleursStatut: Record<HealthStatus, string> = {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4" key={i.id}>
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl flex justify-between items-center">
              ...
              <div className="text-right space-y-1">
                <span className={`border text-xs px-2 py-0.5 rounded font-medium ${couleursStatut[i.health_status]}`}>
                  {i.health_status}
                </span>
                {
